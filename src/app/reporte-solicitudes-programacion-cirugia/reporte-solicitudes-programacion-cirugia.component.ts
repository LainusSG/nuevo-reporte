...
@Component({
  selector: 'app-reporte-solicitudes-programacion-cirugia',
  templateUrl: './reporte-solicitudes-programacion-cirugia.component.html',
  styleUrl: './reporte-solicitudes-programacion-cirugia.component.css'
})
export class ReporteSolicitudesProgramacionCirugiaComponent {
  nombrejefa= "María Dolores Rodríguez Ramírez";
  displayedColumns: string[] = ['Ticket', 'Fecha', 'Paciente', 'Edad', 'Diagnostico', 'Cirugia', 'Sala', 'Turno', 'Estatus'];
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      content: [
         ...
         table(ELEMENT_DATA, ['Ticket', 'Fecha', 'Paciente', 'Edad', 'Diagnostico', 'Cirugia', 'Sala', 'Turno', 'Estatus'], ),
    ],
