...
@Component({
  selector: 'app-reporte-empaque-material-quirofano',
  templateUrl: './reporte-empaque-material-quirofano.component.html',
  styleUrl: './reporte-empaque-material-quirofano.component.css'
})
export class ReporteEmpaqueMaterialQuirofanoComponent {
  nombrejefa= "María Dolores Rodríguez Ramírez";
  displayedColumns: string[] = ['Prioridad', 'Nombre', 'Elaborar', 'Estatus'];
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      content: [
         ...
         table(ELEMENT_DATA, ['Prioridad', 'Nombre', 'Elaborar', 'Estatus'], ),
    ],
